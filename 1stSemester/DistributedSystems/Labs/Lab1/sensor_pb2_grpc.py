...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SendReadings = channel.stream_unary(
                '/SensorService/SendReadings',
                request_serializer=sensor__pb2.SensorData.SerializeToString,
                response_deserializer=sensor__pb2.Summary.FromString,
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendReadings': grpc.stream_unary_rpc_method_handler(
                    servicer.SendReadings,
                    request_deserializer=sensor__pb2.SensorData.FromString,
                    response_serializer=sensor__pb2.Summary.SerializeToString,
            ),
    }
...
class SensorService(object):
    ...
    @staticmethod
    def SendReadings(request_iterator,
            target,
            options=(),
        ...
        return grpc.experimental.stream_unary(
            ...
            sensor__pb2.Summary.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
